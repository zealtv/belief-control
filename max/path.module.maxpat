...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1355.0, 866.0, 24.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1550.0, 905.912664199276151, 24.0, 24.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "off", "on" ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1570.0, 946.0, 44.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 131.77383617184671, 5.756770934761107, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 294.460761225600663, 818.290597457066269, 53.0, 22.0 ],
					"text" : "* 18000."
				}
...
, 			{
				"box" : 				{
					...
					"pinch_enabled" : 0,
					"presentation" : 1,
					"presentation_rect" : [ 281.273836000000074, 30.256770934761107, 450.0, 120.0 ],
					"rotate_enabled" : 0,
					"swipe_enabled" : 0,
					"swipe_touch_count" : 0,
					"tap_enabled" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 439.460761225600663, 818.290597457066269, 47.0, 22.0 ],
					"text" : "* 4800."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 35.794086373229447, 818.290597457066269, 53.0, 22.0 ],
					"text" : "* 18000."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 180.794086373229447, 877.079331183834256, 240.5, 22.0 ],
					"text" : "join 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 180.794086373229447, 764.912664199276151, 240.0, 22.0 ],
					"text" : "unjoin 4"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 564.162836331052631, 764.912664199276151, 150.0, 87.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 748.889000159205807, 791.912664199276151, 119.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 72.035367828153994, 537.666632533073425, 65.0, 22.0 ],
					"text" : "s #0-touch"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 239.833537492537403, -5.243229065238893, 527.880597014925343, 191.0 ],
					"tabname" : "Path-0",
					"varname" : "miraframe"
				}
